...
var auth_reduce_ts_1 = require("./auth-reduce.ts");
var ActionTypes = {
...
var initializedSuccess = function () { return ({
    type: ActionTypes.SET_INITIALIZED,
}); };
exports.initializedSuccess = initializedSuccess;
// Действие для инициализации приложения
var initializeApp = function () { return function (dispatch) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dispatch((0, auth_reduce_ts_1.getAuthUserData)())];
            case 1:
                _a.sent(); // Вызов функции для получения данных пользователя
                dispatch((0, exports.initializedSuccess)()); // Вызов действия initializedSuccess для установки флага initialized в true
                return [2 /*return*/];
        }
    });
}); }; };
exports.initializeApp = initializeApp;
exports.default = appReducer; // Экспорт редуктора
